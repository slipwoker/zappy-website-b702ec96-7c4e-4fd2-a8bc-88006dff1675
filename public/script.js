  ...
  if (contactForm) {
    ...
    function getValidatableFields() {
      return Array.from(contactForm.querySelectorAll(
        'input:not([type="hidden"]):not([type="submit"]):not([type="reset"]):not([type="button"]):not([disabled]), textarea:not([disabled]), select:not([disabled])'
      ));
    }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "GoFlow משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b702ec96-7c4e-4fd2-a8bc-88006dff1675',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b702ec96-7c4e-4fd2-a8bc-88006dff1675';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b702ec96-7c4e-4fd2-a8bc-88006dff1675';
